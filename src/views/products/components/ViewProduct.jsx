      ...
      <section className="bg-white py-10 px-2 sm:px-6 w-[90vw] max-h-[90vh] overflow-auto sm:max-w-[800px] rounded-lg flex flex-col md:flex-row items-center gap-4">
         ...
         <div className="mx-auto max-w-2xl">
            ...
            <dl>
               ...
               <dd className="mb-4 text-accentLight sm:mb-5">
                  {product?.description || "-"}
               </dd>
            </dl>
            <dl className="flex items-center space-x-6">
               <div>
                  ...
                  <dd className="mb-4 text-accentLight sm:mb-5">{product?.category || "-"}</dd>
               </div>
               <div>
                  <dt className="mb-2 font-semibold leading-none text-gray-900">Stock</dt>
                  <dd className="mb-4 text-accentLight sm:mb-5">{product?.stock || "-"}</dd>
               </div>
            </dl>
            <div className="flex items-center space-x-4">
               <button
                  type="button"
                  className="text-white inline-flex items-center gap-2 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-dark hover:bg-dark/90"
                  onClick={onEdit}
               >
